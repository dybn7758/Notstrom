...
/* harmony import */ var _Components_Question_Answers_qa_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/Question_Answers/qa.jsx */ "./client/src/Components/Question_Answers/qa.jsx");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _lib_searchAPI_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib/searchAPI.js */ "./client/src/lib/searchAPI.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'recoil'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var App = function App() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    (0,_lib_searchAPI_js__WEBPACK_IMPORTED_MODULE_4__.listQuestions)(37311); //API call to get questions
  }, []);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'recoil'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, " Himalayas For The Win", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Components_Related_Products_RelatedProducts_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Components_Question_Answers_qa_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], null)));
};
...
/* harmony export */   "listQuestions": function() { return /* binding */ listQuestions; },
/* harmony export */   "listReviews": function() { return /* binding */ listReviews; }
/* harmony export */ });
...
var serverUrl = "https://app-hrsei-api.herokuapp.com/api/fec2/".concat(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../config/config.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var axiosGet = function axiosGet(url) {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_1___default()(options).then(function (data) {
...
var listQuestions = function listQuestions(productId, count, page) {
  //Might not need the count and page parameters yet...
  //if needed, adjust the parameterURL to include these
  var parameterURL = "".concat(serverUrl, "/qa/questions?product_id=").concat(productId);
  return axiosGet(parameterURL);
}; //--------------- API Products -----------------


var listProducts = function listProducts(count, page) {
  //Might not need the count and page parameters yet...
  //if needed, adjust the parameterURL to include these
  var parameterURL = "".concat(serverUrl, "/products");
  return axiosGet(parameterURL);
}; //--------------- API Reviews -----------------


var listReviews = function listReviews(productId, count, page) {
  //Might not need the count and page parameters yet...
  //if needed, adjust the parameterURL to include these
  var parameterURL = "".concat(serverUrl, "/reviews/?product_id=").concat(productId);
  return axiosGet(parameterURL);
