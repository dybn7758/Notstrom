...
const Card = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ position: "absolute", top: 0, left: 10, fontSize: 14 }}>
          Category
        </h1>
        <h1 style={{ position: "absolute", top: 30, left: 10, fontSize: 14 }}>
          $100.00
        </h1>
        <h1 style={{ position: "absolute", top: 15, left: 10, fontSize: 14 }}>
          product
        </h1>
        <div
          style={{
